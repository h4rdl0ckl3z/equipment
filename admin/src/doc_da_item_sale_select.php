<?php
  ...
  if ($access_level == 0 || $access_level == 1) {
    ...
    INNER JOIN room_types ON rooms.room_type_id = room_types.room_type_id)
    INNER JOIN agencys ON agencys.agency_id = rooms.agency_id)
    INNER JOIN communitys ON communitys.community_id = agencys.community_id) WHERE da_items.da_status_ii = '5' OR da_items.da_status_ii = '4' AND agencys.agency_id = '$agency_id'";
  }
