...
console.log(access_level, account_id);
    ...
    $(document).ready(function () {
        var table = $('#Da_ItemTable_Repair').DataTable({
            ...
            columns: [
                ...
                {data: 'da_id', render: function (da_id) {
                    return '<button type="button" name="repair" id="' + da_id + '"class="btn btn-success repair" title="แจ้งซ่อม" onclick="dr()"><i class="fas fa-archive"></i></button>';
                }}
            ],
            "paging": true,
            "lengthChange": true,
            ...
            columns: [
                ...
                {data: 'da_r_id', render: function (da_r_id) {
                    if (check_repair_status == '0') {
                        return '<button type="button" name="update" id="' + da_r_id + '"class="btn btn-info update" title="แจ้งซ่อม" onclick="dr()"><i class="fas fa-share"></i></button>';
                    } else if (check_repair_status == '1') {
